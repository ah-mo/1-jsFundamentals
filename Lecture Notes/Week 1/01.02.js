...
let myName = 'Austin';
let friendName = 'Mansa';

console.log('My name is ' + myName.length + ' letters long.');
console.log('My friend\'s name is ' + friendName.length + ' letters long.');
...
if (myName.length > friendName.length) {
    console.log(myName + ' is longer than ' + friendName + '\'s name.')
} else {
...
if (myName.length > friendName.length) {
    console.log(`${friendName}'s name is shorter than ${myName}'s name.`)
} else {
    console.log(`${friendName}'s name is longer than ${myName}'s name.`)
}
...
if (myName.length == friendName.length) {
    ...
    console.log(myName + ' is longer than ' + friendName + '\'s name by ' + (myName.length-friendName.length) + ' letter(s).');
} else {
    console.log(friendName + '\'s name is longer than ' + myName + ' by ' + (friendName.length-myName.length) + ' letter(s).');
};

if (myName.length > friendName.length) {
    let letters = myName.length - friendName.length;
    console.log(`${friendName}'s name is shorter than mine by ${letters} letters.`);
} else if (myName.length < friendName.length) {
    let letters = friendName.length - myName.length;
    console.log(`${friendName}'s name is longer than ${myName} by ${letters} letters.`);
};
